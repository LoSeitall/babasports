...
<div id="J_goodsList" class="goods-list-v1 gl-type-1 J-goods-list">
	<ul class="gl-warp clearfix" data-tpl="1">
		...
		<li data-sku="1711416562" class="gl-item">
			<div class="gl-i-wrap">
				<div class="p-img">
					<a href="javascript:;" onclick="window.open('http://localhost:8082/html/${product.id}.html')" style="position: relative;">
				...
				<div class="p-name p-name-type-2">
					<a target="_blank" title="满129立减10,199减20优惠券,支持货到付款" href="javascript:;" onclick="window.open('http://localhost:8082/html/${product.id}.html')"">
						<em>${product.name }</em>
					</a>
				</div>
				<div class="p-commit">
