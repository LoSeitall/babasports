...
<div class="box-positon">
    <div class="rpos">当前位置: 商品管理 - 更新</div>
    <form class="ropt">
...
<div class="body-box" style="float:right">
    <form id="jvForm" action="updateProduct" method="post" enctype="multipart/form-data">
        <table cellspacing="1" cellpadding="2" width="100%" border="0" class="pn-ftable">
            ...
            <tr>
                ...
                <td width="80%" class="pn-fcontent">
					<c:forEach items="${color }" var="c">
                    	<input type="checkbox" value="${c.id }" name="colorss"
            ...
            <tr>
                <td>
                    <textarea rows="20" cols="180" id="productdesc" name="description" value="${product.description }">${product.description }</textarea>
                </td>
            </tr>
            </tbody>
            ...
            <tr>
                <td>
                    <textarea rows="20" cols="180" id="productList" name="packageList" value="${product.packageList }">${product.packageList }</textarea>
                </td>
            </tr>
            </tbody>
            <tbody>
