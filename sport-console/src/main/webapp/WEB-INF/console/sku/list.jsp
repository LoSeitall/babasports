...
<head>
    ...
    <script>
        ...
        function addSku(id) {
            ...
            $.ajax({
            	type : "get",
            	url : "skuUpdate?id="+$("#"+"id"+id).val()+"&marketPrice="+$("#"+"m"+id).val()+"&price="+$("#"+"p"+id).val()+"&stock="
            	+$("#"+"i"+id).val()+"&upperLimit="+$("#"+"l"+id).val()+"&deliveFee="+$("#"+"f"+id).val(),
/*             	data : {id:$("id"+id).val(),
    ...
    <form method="post" id="tableForm">
        <table cellspacing="1" cellpadding="0" border="0" width="100%" class="pn-ltable">
            ...
            <c:forEach items="${skulist }" var="sku">
	                <form id="skudata${sku.id }">
	            <tr bgcolor="#ffffff" onmouseover="this.bgColor='#eeeeee'" onmouseout="this.bgColor='#ffffff'">
	                <td align="center"><input type="checkbox" name="ids" value="73"/></td>
	                <input type="hidden" id="id${sku.id }" name="id" value="${sku.id }"/>
	                <td align="center">${sku.productId }</td>
	                <td align="center">${sku.colorName }</td>
	                <td align="center">${sku.size }</td>
	                <td align="center"><input type="text" name="marketPrice" id="m${sku.id }" value="${sku.marketPrice }" disabled="disabled" size="10"/></td>
	                <td align="center"><input type="text" name="price" id="p${sku.id }" value="${sku.price }" disabled="disabled" size="10"/></td>
	                <td align="center"><input type="text" name="stock" id="i${sku.id }" value="${sku.stock }" disabled="disabled" size="10"/></td>
	                <td align="center"><input type="text" name="upperLimit" id="l${sku.id }" value="${sku.upperLimit }" disabled="disabled" size="10"/></td>
	                <td align="center"><input type="text" name="deliveFee" id="f${sku.id }" value="${sku.deliveFee }" disabled="disabled" size="10"/></td>
...
<!--            <tr bgcolor="#ffffff" onmouseover="this.bgColor='#eeeeee'" onmouseout="this.bgColor='#ffffff'">
                ...
                <td align="center">不是</td>
                <td align="center"><a href="javascript:updateSku(53)" class="pn-opt">修改</a> | <a
                        href="javascript:addSku(53)" class="pn-opt">保存</a></td>
            </tr>
            ...
            <tr bgcolor="#ffffff" onmouseover="this.bgColor='#eeeeee'" onmouseout="this.bgColor='#ffffff'">
                ...
                <td align="center">不是</td>
                <td align="center"><a href="javascript:updateSku(54)" class="pn-opt">修改</a> | <a
                        href="javascript:addSku(54)" class="pn-opt">保存</a></td>
            </tr>
            ...
            <tr bgcolor="#ffffff" onmouseover="this.bgColor='#eeeeee'" onmouseout="this.bgColor='#ffffff'">
                ...
                <td align="center">不是</td>
                <td align="center"><a href="javascript:updateSku(55)" class="pn-opt">修改</a> | <a
                        href="javascript:addSku(55)" class="pn-opt">保存</a></td>
            </tr>
            ...
            <tr bgcolor="#ffffff" onmouseover="this.bgColor='#eeeeee'" onmouseout="this.bgColor='#ffffff'">
                ...
                <td align="center">不是</td>
                <td align="center"><a href="javascript:updateSku(56)" class="pn-opt">修改</a> | <a
                        href="javascript:addSku(56)" class="pn-opt">保存</a></td>
            </tr>
            ...
            <tr bgcolor="#ffffff" onmouseover="this.bgColor='#eeeeee'" onmouseout="this.bgColor='#ffffff'">
                ...
                <td align="center">不是</td>
                <td align="center"><a href="javascript:updateSku(57)" class="pn-opt">修改</a> | <a
                        href="javascript:addSku(57)" class="pn-opt">保存</a></td>
            </tr>
            ...
            <tr bgcolor="#ffffff" onmouseover="this.bgColor='#eeeeee'" onmouseout="this.bgColor='#ffffff'">
                ...
                <td align="center">不是</td>
                <td align="center"><a href="javascript:updateSku(58)" class="pn-opt">修改</a> | <a
                        href="javascript:addSku(58)" class="pn-opt">保存</a></td>
            </tr>
            ...
            <tr bgcolor="#ffffff" onmouseover="this.bgColor='#eeeeee'" onmouseout="this.bgColor='#ffffff'">
                ...
                <td align="center">不是</td>
                <td align="center"><a href="javascript:updateSku(59)" class="pn-opt">修改</a> | <a
                        href="javascript:addSku(59)" class="pn-opt">保存</a></td>
            </tr>
            ...
            <tr bgcolor="#ffffff" onmouseover="this.bgColor='#eeeeee'" onmouseout="this.bgColor='#ffffff'">
                ...
                <td align="center">不是</td>
                <td align="center"><a href="javascript:updateSku(60)" class="pn-opt">修改</a> | <a
                        href="javascript:addSku(60)" class="pn-opt">保存</a></td>
            </tr> -->
            </tbody>
        </table>
    </form>
