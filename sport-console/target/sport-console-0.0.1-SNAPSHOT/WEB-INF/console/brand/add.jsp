...
<head>
    ...
    <script src="../../../ajaxfileupload.js" type="application/javascript"></script>
    <script>
        //上传图片
        function uploadPic() {
            $.ajaxFileUpload({
                    url : "/brand/uploadBrandImg",
                    secureuri : false,
                    fileElementId : "imgU",
                    dataType : 'text',
...
<div class="body-box" style="float:right">
    <form id="jvForm" action="/brand/brandInsert" method="post" enctype="multipart/form-data">
        <table cellspacing="1" cellpadding="2" width="100%" border="0" class="pn-ftable">
            ...
            <tr>
                ...
                <td width="80%" class="pn-fcontent">
                    ...
                    <input type="file" id="imgU" name="imgU" onchange="uploadPic();" />
                </td>
            </tr>
            <tr>
                <td width="20%" class="pn-flabel pn-flabel-h">
